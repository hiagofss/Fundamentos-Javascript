class JogoDaMemoria {
    constructor({ tela, util }) {
        ...
        this.iconePadrao = './files/default.png';
        this.heroisIniciais = [
            { img: './files/batman.png', nome: 'BATMAN' },
            { img: './files/captain american.png', nome: 'CAPTAIN AMERICAN' },
            // { img: './files/flash.png', nome: 'FLASH' },
            // { img: './files/groot.png', nome: 'GROOT' },
            // { img: './files/iron man.png', nome: 'IRON MAN' },
            // { img: './files/minion.png', nome: 'MINION' },
            // { img: './files/mutant.png', nome: 'MUTANT' },
            // { img: './files/robot.png', nome: 'ROBOT' },
            // { img: './files/spider man.png', nome: 'SPIDER MAN' },
    ...
    inicializar() {
        ...
        this.tela.configurarClickVerificarSelecao(
